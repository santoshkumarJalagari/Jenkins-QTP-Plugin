...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","c:\\maven\\bin\\JenkinsPlugin");
    parameters.put("artifactId","JenkinsPlugin");
    parameters.put("outputDirectory","c:\\maven\\bin\\JenkinsPlugin\\target\\classes");
    parameters.put("testOutputDirectory","c:\\maven\\bin\\JenkinsPlugin\\target\\test-classes");
